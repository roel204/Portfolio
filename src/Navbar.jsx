...
const Navbar = () => {
    ...
    if (!isMobile) {
        return (
            <aside className="fixed top-0 left-0 z-40 w-[6vw] h-screen text-sm text-gray-900 dark:text-gray-200"
                   aria-label="Sidebar">
                <div
                    className="h-full w-full flex flex-col items-center border-r-2 border-cgreen justify-between px-2 py-4 overflow-y-auto bg-green-200 dark:bg-[#252525]">
                    <a href="/Portfolio/">
                        <img src="public/RHlogo.png" alt="Git Logo"
                             className="w-full rounded object-contain transition duration-75 hover:scale-110"/>
                    </a>
                    <ul className="space-y-2 pb-4 font-medium w-full border-b border-gray-200 dark:border-gray-700">
                        <li>
                            <a href="/Portfolio/"
                               className="flex flex-col text-center items-center py-2 rounded-lg hover:bg-dgreen dark:hover:bg-cgreen group">
                                <svg
        ...
        return (
            <>
                <button
                    ...
                    className="block text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 focus:outline-none focus:text-gray-900">
                    {isOpen ? (
                ...
                {isOpen && (
                    <div className="fixed inset-0 z-50 bg-white dark:bg-gray-900">
                        <div className="flex flex-col items-center justify-center h-screen">
                            {/* Mobile menu content */}
                            <ul className="space-y-2 pb-4 font-medium">
                                <li>
                                    <a href="/Portfolio/" className="block px-4 py-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-800">
                                        Home
                                    </a>
                                </li>
                                <li>
                                    <a href="/Portfolio/projects" className="block px-4 py-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-800">
                                        Projects
                                    </a>
                                </li>
                                <li>
                                    <a href="/Portfolio/skills" className="block px-4 py-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-800">
                                        Skills
                                    </a>
                                </li>
                            </ul>
                            <div className="flex flex-col items-center w-full pt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                                <button
                                    className="block w-full px-4 py-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-800"
                                    onClick={toggleDarkMode}
                                >
                                    {darkMode === 'off' ? 'Darkmode' : 'Lightmode'}
                                </button>
                                <button
                                    className="block w-full px-4 py-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-800"
