        ...
        return (
            <>
                <button
                    ...
                    className="fixed text-gray-500 dark:text-gray-400">
                    {isOpen ? (
                    ...
                    <aside className="fixed top-0 left-0 z-40 w-[70vw] h-screen text-sm text-gray-900 dark:text-gray-200" aria-label="Sidebar">
                        <div className="h-full w-full flex flex-col items-center justify-center border-r-2 border-cgreen px-2 py-4 overflow-y-auto bg-green-200 dark:bg-[#252525]">
                            ...
                            <ul className="space-y-4 pb-4 font-medium w-full border-b border-gray-200 dark:border-gray-700">
                                <li>
                                    <a href="/Portfolio/" className="flex items-center p-2 rounded-lg">
                                        <svg className="flex-shrink-0 w-10 h-10 mr-5 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 576 512">
                                ...
                                <li>
                                    <a href="/Portfolio/projects" className="flex items-center p-2 rounded-lg">
                                        <svg className="flex-shrink-0 w-10 h-10 mr-5 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                                ...
                                <li>
                                    <a href="/Portfolio/skills" className="flex items-center p-2 rounded-lg">
                                        <svg className="flex-shrink-0 w-10 h-10 mr-5 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 640 512">
                            ...
                            <ul className="py-4 space-y-4 w-full font-medium">
                                <li>
                                    <a href="mailto:roelhoogendoorn01369@gmail.com" target="_blank" className="flex items-center p-2 rounded-lg"
                                       rel="noreferrer noopener">
                                        <svg className="flex-shrink-0 w-10 h-10 mr-5 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512">
                                ...
                                <li>
                                    <a href="https://github.com/roel204" target="_blank" className="flex items-center p-2 rounded-lg"
                                       rel="noreferrer noopener">
                                        <svg className="flex-shrink-0 w-10 h-10 mr-5 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 496 512">
                                ...
                                <li>
                                    <a href="https://www.linkedin.com/in/roel-hoogendoorn/" target="_blank" className="flex items-center p-2 rounded-lg"
                                       rel="noreferrer noopener">
                                        <svg className="flex-shrink-0 w-10 h-10 mr-5 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 448 512">
                            ...
                            <div className="flex flex-col items-center w-full pt-4 space-y-4 font-medium border-t border-gray-200 dark:border-gray-700">
                                <button className="flex w-full items-center p-2 rounded-lg" onClick={toggleDarkMode}>
                                    <svg className="flex-shrink-0 w-10 h-10 mr-5 text-gray-900 dark:text-yellow-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 384 512">
                                        <path d="M272 384c9.6-31.9 29.5-59.1 49.2-86.2l0 0c5.2-7.1 10.4-14.2 15.4-21.4c19.8-28.5 31.4-63 31.4-100.3C368 78.8 289.2 0 192 0S16 78.8 16 176c0 37.3 11.6 71.9 31.4 100.3c5 7.2 10.2 14.3 15.4 21.4l0 0c19.8 27.1 39.7 54.4 49.2 86.2H272zM192 512c44.2 0 80-35.8 80-80V416H112v16c0 44.2 35.8 80 80 80zM112 176c0 8.8-7.2 16-16 16s-16-7.2-16-16c0-61.9 50.1-112 112-112c8.8 0 16 7.2 16 16s-7.2 16-16 16c-44.2 0-80 35.8-80 80z"/>
                                    </svg>
                                    <span>{darkMode === 'off' ? 'Darkmode' : 'Lightmode'}</span>
                                </button>
                                <button className="flex w-full items-center p-2 rounded-lg" onClick={toggleLanguage}>
                                    <div className={`${language === 'nl' ? 'uk-flag' : 'dutch-flag'} w-10 mr-5`}></div>
                                    <span>{texts[language].languageButton}</span>
                                </button>
                            </div>
                        </div>
