            ...
            <aside className="fixed top-0 left-0 z-40 w-[6vw] h-screen text-sm text-gray-900 dark:text-gray-200" aria-label="Sidebar">
                <div className="h-full w-full flex flex-col items-center border-r-2 border-cgreen justify-between px-2 py-4 overflow-y-auto bg-green-200 dark:bg-[#252525]">
                    ...
                    <ul className="space-y-2 pb-4 font-medium w-full border-b border-gray-200 dark:border-gray-700">
                        <li>
                        <Link to="/Portfolio/" className="flex flex-col text-center items-center py-2 rounded-lg hover:bg-dgreen dark:hover:bg-cgreen group">
                        ...
                        <li>
                            <Link to="/Portfolio/projects" className="flex flex-col items-center p-2 rounded-lg hover:bg-dgreen dark:hover:bg-cgreen group">
                                <svg className="flex-shrink-0 w-[40%] text-gray-500 transition duration-75 group-hover:scale-110 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                     aria-hidden="true"
                        ...
                        <li>
                            <Link to="/Portfolio/skills" className="flex flex-col items-center p-2 rounded-lg hover:bg-dgreen dark:hover:bg-cgreen group">
                                <svg className="flex-shrink-0 w-[40%] text-gray-500 transition duration-75 group-hover:scale-110 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                     aria-hidden="true"
            ...
            <>
                <button
                    ...
                    {isOpen ? (
                        ...
                        <svg
                            className="w-[15vw] text-red-700 z-50" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                {isOpen && (
                    <aside className="fixed top-0 left-0 z-40 w-[70vw] h-screen text-sm text-gray-900 dark:text-gray-200" aria-label="Sidebar">
                        <div className="h-full w-full flex flex-col items-center justify-center border-r-2 border-cgreen px-2 py-4 overflow-y-auto bg-green-200 dark:bg-[#252525]">
                            ...
                            <Link to="/Portfolio/" className="pb-[5vh]">
                            ...
                            <ul className="space-y-4 pb-4 font-medium w-full border-b border-gray-200 dark:border-gray-700">
                                <li>
                                    <Link to="/Portfolio/" className="flex items-center p-2">
                                ...
                                <li>
                                    <Link to="/Portfolio/projects" className="flex items-center p-2">
                                ...
                                <li>
                                    <Link to="/Portfolio/skills" className="flex items-center p-2">
                            ...
                            <div className="flex flex-col items-center w-full pt-4 space-y-4 font-medium border-t border-gray-200 dark:border-gray-700">
                                <button className="flex w-full items-center p-2" onClick={toggleDarkMode}>
                                    <svg className="flex-shrink-0 w-[9%] mr-5 text-gray-900 dark:text-yellow-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 384 512">
