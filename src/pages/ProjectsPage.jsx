            ...
            <div className="flex overflow-x-auto scrollbar-hide py-[4vh] border-b border-cgreen bg-green-100/75 dark:bg-black/75" ref={containerRef}>
                {projectsCards.map((project, index) => (
                    <HashLink to={`/projects#${index}`} key={index}
                              className="w-[75vw] sm:w-[20vw] h-[22vh] flex-shrink-0 flex flex-col mx-6 bg-dgreen dark:bg-cgreen rounded-lg p-6 relative transition scale-95 sm:hover:scale-110">
                        {/* Title */}
                        ...
                        {/* shortDesc */}
                        <p className="mt-4 text-">{project.desc[language]}</p>
