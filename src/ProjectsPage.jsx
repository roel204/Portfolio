...
const ProjectsPage = () => {
    ...
    const projects = [
        {title: 'Project 1', shortDesc: 'shortDesc of Project 1', longDesc: 'shortDesc of Project 1', githubLink: 'https://github.com/project1'},
        {title: 'Project 2', shortDesc: 'shortDesc of Project 2', longDesc: 'shortDesc of Project 2', githubLink: 'https://github.com/project2'},
        {title: 'Project 3', shortDesc: 'shortDesc of Project 3', longDesc: 'shortDesc of Project 3', githubLink: 'https://github.com/project3'},
        {title: 'Project 4', shortDesc: 'shortDesc of Project 4', longDesc: 'shortDesc of Project 4', githubLink: 'https://github.com/project4'},
        {title: 'Project 5', shortDesc: 'shortDesc of Project 5', longDesc: 'shortDesc of Project 5', githubLink: 'https://github.com/project5'},
        {title: 'Project 6', shortDesc: 'shortDesc of Project 6', longDesc: 'shortDesc of Project 6', githubLink: 'https://github.com/project6'},
        {title: 'Project 7', shortDesc: 'shortDesc of Project 7', longDesc: 'shortDesc of Project 7', githubLink: 'https://github.com/project7'},
        {title: 'Project 8', shortDesc: 'shortDesc of Project 8', longDesc: 'shortDesc of Project 8', githubLink: 'https://github.com/project8'},
        {title: 'Project 9', shortDesc: 'shortDesc of Project 9', longDesc: 'shortDesc of Project 9', githubLink: 'https://github.com/project9'},
    ];
            ...
            <div className="flex overflow-x-auto scrollbar-hide py-32 border-b border-cgreen" ref={containerRef}>
                {projects.map((project, index) => (
                    <a href="#" key={index} className="w-96 h-[50vh] flex-shrink-0 flex flex-col mx-6 bg-cgreen rounded-lg p-6 relative z-10 transition scale-95 hover:scale-110">
                        ...
                        {/* shortDesc */}
                        <p className="mt-8 text-sm">{project.shortDesc}</p>
